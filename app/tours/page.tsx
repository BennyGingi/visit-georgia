...
const tours: Tour[] = [
  {
    ...
    groupSizeHe: '2-12 אנשים',
    groupSizeRu: '2-12 человек',
    bestSeason: 'May-October',
    bestSeasonHe: 'מאי-אוקטובר',
    bestSeasonRu: 'Май-Октябрь',
    durationHe: '7 ימים / 6 לילות',
    durationRu: '7 дней / 6 ночей',
  },
  {
    ...
    groupSizeHe: '4-8 אנשים',
    groupSizeRu: '4-8 человек',
    bestSeason: 'June-September',
    bestSeasonHe: 'יוני-ספטמבר',
    bestSeasonRu: 'Июнь-Сентябрь',
    durationHe: '5 ימים / 4 לילות',
  ...
  },
  {
    ...
    groupSizeHe: '2-10 אנשים',
    groupSizeRu: '2-10 человек',
    bestSeason: 'April-November',
    bestSeasonHe: 'אפריל-נובמבר',
    bestSeasonRu: 'Апрель-Ноябрь',
    durationHe: '4 ימים / 3 לילות',
...
function TourDetailModal({ tour, t, isRTL, onClose, lang }: any) {
  ...
  const tourDuration = lang === 'he' ? tour.durationHe : lang === 'ru' ? tour.durationRu : tour.duration
  const tourGroupSize = lang === 'he' ? tour.groupSizeHe : lang === 'ru' ? tour.groupSizeRu : tour.groupSize
  const tourBestSeason = lang === 'he' ? tour.bestSeasonHe : lang === 'ru' ? tour.bestSeasonRu : tour.bestSeason
      ...
      >
        ...
        <div className="relative h-64 md:h-80">
          ...
          <div className="absolute bottom-6 left-6 right-6">
            ...
            <p className="text-white/80 text-lg">{tourDuration}</p>
          </div>
        </div>
        ...
        <div className="p-6 md:p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-espresso/5 dark:bg-white/5 rounded-xl p-4">
              ...
              <p className="text-espresso dark:text-white font-medium">{tourGroupSize}</p>
            </div>
            <div className="bg-espresso/5 dark:bg-white/5 rounded-xl p-4">
              <p className="text-espresso/50 dark:text-white/50 text-sm mb-1">{t.bestSeason}</p>
              <p className="text-espresso dark:text-white font-medium">{tourBestSeason}</p>
            </div>
          </div>
